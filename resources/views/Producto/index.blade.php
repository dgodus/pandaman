...
@section('content')
    ...
    <div class="col-md-12">
        ...
        <a href="{{route('producto.create')}}" class="btn btn-outline-success btn-rounded waves-effect btn-lg"><i class="fas fa-solid fa-clipboard-list pr-2"
         aria-hidden="true"></i>Agregar Nueva Producto</a>
</div>
